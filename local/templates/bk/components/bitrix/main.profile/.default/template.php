...
<table class="profile-table data-table table table-striped">
	<thead>
		<tr>
			<td colspan="2">&nbsp;</td>
		</tr>
...
<table class="data-table profile-table table table-striped">
	<thead>
		<tr>
			<td colspan="2">&nbsp;</td>
		</tr>
...
<table class="data-table profile-table table table-striped">
	...
	<p><input type="submit" class="btn btn-lg btn-default" name="save" value="<?=(($arResult["ID"]>0) ? GetMessage("MAIN_SAVE") : GetMessage("MAIN_ADD"))?>">&nbsp;&nbsp;<input class="btn btn-lg btn-default" type="reset" value="<?=GetMessage('MAIN_RESET');?>"></p>
</form>
<?
