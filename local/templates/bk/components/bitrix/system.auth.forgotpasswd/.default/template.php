...
<table class="table data-table bx-forgotpass-table">
	<thead>
		<tr> 
	...
	<tbody>
		<tr>
			...
			<td><input type="text" class="form-control name="USER_LOGIN" maxlength="50" value="<?=$arResult["LAST_LOGIN"]?>" />&nbsp;<?=GetMessage("AUTH_OR")?>
			</td>
		</tr>
		<tr> 
