...
<?endif?>
	...
	<form name="form_auth" role="form" method="post" target="_top" action="<?=$arResult["AUTH_URL"]?>">
...
<?endif?>
			<tr>
				<td></td>
				<td class="authorize-submit-cell"><input type="submit" class="btn btn-default" name="Login" value="<?=GetMessage("AUTH_AUTHORIZE")?>" /></td>
			</tr>
		</table>
